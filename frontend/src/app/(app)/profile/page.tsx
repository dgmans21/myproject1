...
function ProfileMemberContent() {
  ...
  const basicInfoChanged = ageGroupDraft !== profile.age_group;
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-6">
        ...
        {tab === "info" && (
          <>
            <Card className="mt-6">
              <CardTitle className="text-base">나이대</CardTitle>
              <CardDescription className="mt-1">
                프로필 상단과 방 멤버 목록에 표시됩니다. 거주지는 집 주소 저장 시 자동 반영됩니다.
              </CardDescription>
              <div className="mt-4">
